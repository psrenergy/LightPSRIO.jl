...
@testset "Binary" begin
    ...
    create_quiver("input1"; n_stages = 4, n_scenarios = 3, n_blocks = 2, constant = 2.0)
    create_quiver("input2"; n_stages = 1, n_scenarios = 2, n_blocks = 3, constant = 3.0)
    create_quiver("input3"; n_stages = 3, n_scenarios = 1, n_blocks = 3, constant = 4.0)
    create_quiver("input4"; n_stages = 3, n_scenarios = 2, n_blocks = 1, constant = 5.0)
    create_quiver("input5"; n_stages = 3, n_scenarios = 2, n_blocks = 3, constant = 6.0)
